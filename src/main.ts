...
class LeafpressSettingTab extends PluginSettingTab {
  ...
  private displayFontSettings(containerEl: HTMLElement): void {
    ...
    new Setting(containerEl)
      ...
      .setDesc(
        // eslint-disable-next-line obsidianmd/ui/sentence-case -- Font names are proper nouns
  ...
  private displayNoteTemplate(containerEl: HTMLElement): void {
    new Setting(containerEl)
      ...
      // eslint-disable-next-line obsidianmd/ui/sentence-case -- Obsidian frontmatter field names are case-sensitive
  ...
  private displayDeploymentSettings(containerEl: HTMLElement): void {
    ...
    new Setting(containerEl)
      ...
      .addDropdown((dd) => {
        // eslint-disable-next-line obsidianmd/ui/sentence-case -- Brand name is stylized as-is
    ...
    new Setting(containerEl)
      .setName("Configure")
      // eslint-disable-next-line obsidianmd/ui/sentence-case -- Setup guide is a section within settings
...
class NavItemModal extends Modal {
  ...
  onOpen() {
    ...
    new Setting(contentEl)
      ...
      .addText((text) => {
        text
          .setPlaceholder("For example- notes")
